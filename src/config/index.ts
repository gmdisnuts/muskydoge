...
export const CAKE_PER_BLOCK = new BigNumber(69)
export const BLOCKS_PER_YEAR = new BigNumber((60 / BSC_BLOCK_TIME) * 60 * 24 * 365) // 10512000
export const BASE_URL = 'https://www.balloonswap.com'
export const BASE_EXCHANGE_URL = 'https://exchange.balloonswap.com'
